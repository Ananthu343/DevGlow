  ...
  return (
    <div className='w-full h-full flex flex-col p-3'>
      <div className='w-full flex justify-between pl-3 pr-2 mb-2'>
        ...
        <div>
          <svg onClick={()=>setOpenCall(true)}  xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6 cursor-poiter">
