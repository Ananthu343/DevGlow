            ...
            <div className='border-t w-full pl-4'>
                {filteredUsers.map((user, index) => (
                    <div className='flex items-center border-b p-1 cursor-pointer' key={index}>
                        <img className='border border-[#720058] w-7 rounded-full mr-2 hidden lg:flex object-cover' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRSinUiRqVB94sfZZbtNZgPJswUTs4R7YDskvXfVjUSejKfQqAoMaedQBNfybdIdduiix4&usqp=CAU" alt="profile pic" />
